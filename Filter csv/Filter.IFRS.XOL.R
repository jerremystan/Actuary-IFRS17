...
write.csv(df_ifrs_group, "Output/ifrs_group_2023_202312_2.csv", row.names = FALSE, na = "")
write.csv(df_ifrs_cf, "Output/ifrs_group_cashflow_all_runs_2023_202312_2.csv", row.names = FALSE, na = "")
write.csv(disc_df, "Output/ifrs_group_discount_rate_all_runs_2023_202312_2.csv", row.names = FALSE, na = "")
write.csv(df_variable, "Output/variable_all_runs_2023_202312_2.csv", row.names = FALSE, na = "")
write.csv(df_variable_mp, "Output/variable_cashflow_mapping_2.csv", row.names = FALSE, na = "")
